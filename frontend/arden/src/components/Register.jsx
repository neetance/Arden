...
function InsurancePage() {
  ...
  const handlePurchase = async(e) => {
    ...
    const tx = await contract.mint(signer.getAddress(), metadata.description, metadata.duration, metadata.coverageAmount, metadata.insuranceType, uri, {value: ethers.parseUnits(premium.toString(), 18)});
  };
