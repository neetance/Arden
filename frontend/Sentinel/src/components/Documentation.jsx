      ...
      <section className="px-8 py-12 max-w-6xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-lg mb-4">
            Sentinel is a decentralized insurance protocol designed for DeFi
          ...
          <p className="text-lg mb-8">
            What makes Sentinel unique is its approach to claim handling - all
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            ...
            <div className="text-gray-300">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  • Long-term: Sentinel can implement slashing conditions for
                  bad faith votes
                </li>
                <li>
        ...
        <div className="space-y-8">
            ...
            <div>
              ...
              <div className="bg-gray-800 p-4 rounded border border-gray-700">
                <ul className="space-y-2 text-gray-300">
                  <li>• Selects "Custom Policy" on Sentinel</li>
                  <li>
          ...
          <div className="flex">
            ...
            <div>
              ...
              <div className="bg-gray-800 p-4 rounded border border-gray-700">
                <ul className="space-y-2 text-gray-300">
                  <li>• User returns to Sentinel and files a claim</li>
      ...
      <footer className="px-8 py-12 border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex justify-center items-center mb-6">
            ...
            <h2 className="text-2xl font-semibold tracking-tight">Sentinel</h2>
          </div>
